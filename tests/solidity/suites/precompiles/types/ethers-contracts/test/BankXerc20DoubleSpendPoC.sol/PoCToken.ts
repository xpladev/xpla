...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common/index.js";
  ...
  export interface PoCTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface PoCToken extends BaseContract {

    connect(runner?: ContractRunner | null): PoCToken;
    waitForDeployment(): Promise<this>;

    interface: PoCTokenInterface;
