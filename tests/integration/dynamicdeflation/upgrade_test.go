...
func verifyV112UpgradeLifecycle(t *testing.T, app *xplaapp.XplaApp) {
	...
	require.Equal(t, "10000000000000000000000", dynamicParams.MinFeeAmount.Amount.String())
	require.Equal(t, "500000000000000000000000", dynamicParams.MaxFeeAmount.Amount.String())
