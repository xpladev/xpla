...
import (
	...
	"github.com/xpladev/xpla/legacy/ethermint/crypto/ethsecp256k1"
	"github.com/xpladev/xpla/legacy/ethermint/crypto/hd"
)

// UnsafeExportEthKeyCommand exports a key with the given name as a private key in hex format.
func UnsafeExportLegacyEthKeyCommand() *cobra.Command {
	return &cobra.Command{
		Use:   "unsafe-export-legacy-eth-key [name]",
		Short: "**UNSAFE** Export an Ethereum private key from legacy ethermint key",
