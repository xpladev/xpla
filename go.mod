...
replace (
	...
	// xpla features
	github.com/cosmos/cosmos-sdk => github.com/xpladev/cosmos-sdk v0.50.5-0.20250625114125-0284058c0b3d

	// XXX for build
	github.com/cosmos/evm/evmd => ./deps/evmd
	...
	// xpla features
	//github.com/ethereum/go-ethereum => github.com/xpladev/go-ethereum v1.10.26-xpla-evm
	// XXX for build
