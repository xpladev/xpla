...
replace (
	...
	// xpla features
	github.com/cosmos/cosmos-sdk => github.com/xpladev/cosmos-sdk v0.54.3-xpla
	...
	github.com/ethereum/go-ethereum => github.com/xpladev/go-ethereum v1.17.2-cosmos-0-xpla-0
